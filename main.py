...
def handle_message(event):
    ...
    if text_received in ["ดูที่เที่ยว", "เว็บเที่ยว", "ดูแกลลอรี", "เว็บ", "web", "a"]:
    ...
    # 👉 2. จุดที่แทรกเพิ่ม: เช็คคีย์เวิร์ด "บริการของเรา" (จากปุ่ม B)
    if text_received in ["บริการของเรา", "บริการ", "b"]:
        service_text = (
            "✨ บริการของ Benis(เบนิส) ✨\n\n"
            "เราคือผู้ช่วยเก็บพิกัดที่เที่ยวและร้านอาหารจาก TikTok และ IG ของคุณ! 🗺️\n\n"
            "🔹 ส่งลิงก์คลิปมา เราดึงข้อมูลให้\n"
            "🔹 แยกหมวดหมู่ จังหวัด ให้อัตโนมัติ\n"
            "🔹 จัดเก็บเป็นแกลลอรีสวยงาม ดูง่าย\n"
            "🔹 ชวนเข้ากลุ่มเพื่อนเพื่อช่วยกันแพลนทริปได้\n\n"
            "ให้เราช่วยจำ จะได้ไม่พลาดที่เด็ดๆ นะครับ 😉"
        )
        line_bot_api.reply_message(
            event.reply_token,
            TextSendMessage(text=service_text)
        )
        return

    # 👉 3. จุดที่แทรกเพิ่ม: เช็คคีย์เวิร์ด "วิธีใช้งาน" (จากปุ่ม C)
    if text_received in ["วิธีใช้", "วิธีใช้งาน", "คำสั่ง", "คู่มือ", "เมนู", "c"]:
        help_text = (
            "🤖 คู่มือการใช้งาน Benis(เบนิส) 🗺️\n\n"
            "👤 พิมพ์ในแชทส่วนตัว:\n"
            "- ส่งลิงก์ TikTok/IG มาได้เลย จดยังไงก็ไม่ตกหล่น!\n"
            "- กดเมนูด้านล่าง หรือพิมพ์ 'เว็บเที่ยว' เพื่อดูแกลลอรี\n\n"
            "👥 พิมพ์ในกลุ่มเพื่อน:\n"
            "1️⃣ พิมพ์ 'ไปเที่ยวกัน' (เพื่อปลุกให้บอทเตรียมสมุดจด)\n"
            "2️⃣ ส่งลิงก์ TikTok หรือ IG ลงในกลุ่ม\n"
            "3️⃣ พิมพ์ 'ยกเลิก' (เมื่อส่งลิงก์เสร็จ บอทจะได้พัก)\n"
            "4️⃣ พิมพ์ 'เว็บเที่ยว' เพื่อดูแพลนของกลุ่ม"
        )
        line_bot_api.reply_message(
            event.reply_token,
